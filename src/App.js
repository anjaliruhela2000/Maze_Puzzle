...
class App extends Component {
    ...
    render() {
            ...
            mazeState = (
                <g>
                    <svg xmlns="http://www.w3.org/2000/svg">
                        ...
                        <text x="310" y="175" fontFamily="Monospace" fontSize="20" stoke="black" fill="black">MAZE GAME</text>
                        ...
                        <text x="310" y="425" fontFamily="Monospace" fontSize="15" fill="silver" class-name="play-button" onClick={this.play}>START GAME</text>
                    </svg>
                </g>
            )
        } else if (title === false && stop === false && winner === false && quit === false && leaderboard === false) {
            mazeState = (
                <g>
                    <svg xmlns="http://www.w3.org/2000/svg">
                        <rect x="45" y="35" width="70" height="35" fill="black"/>
                        <text x="55" y="58" fontFamily="Monospace" fontSize="15" fill="silver" onClick={this.start} className="start-button">START</text>
                        <text x="260" y="250" fontFamily="monospace" fontSize="45" stroke="black" fill="red">LEVEL {mazesIndex + 1}</text>
                    </svg>
                </g>
            )
        } else if (title === false && start === true && stop === false && winner === false && quit === false && leaderboard === false) {
        ...
        } else if (title === false && start === true && stop === true && winner === false && quit === false && leaderboard === false) {
            mazeState = (
                <g>
                    <svg xmlns="http://www.w3.org/2000/svg">
        ...
        } else if (title === false && start === true && stop === false && winner === true && quit === false && leaderboard === false) {
            mazeState = (
                <g>
                    <svg xmlns="http://www.w3.org/2000/svg">
        ...
        } else if (quit === true && leaderboard === false) {
            mazeState = (
                <g>
                    <svg xmlns="http://www.w3.org/2000/svg">
                        ...
                        <text x="440" y="370" fontFamily="Monospace" fontSize="15" fill="silver" onClick={this.leaderboard} className="leaderboard-button">LEADERBOARD</text>
                    </svg>
                </g>
            )
        } else if (quit === true && leaderboard === true) {
            mazeState = (
                <g>
                    <svg xmlns="http://www.w3.org/2000/svg">
        ...
        return (
            <div className="App">
                ...
                <AudioPlayer song={music} start={this.state.start} stop={this.state.stop} winner={this.state.winner} quit={this.state.quit} leaderboard={this.state.leaderboard} mazeIndex={this.state.mazeIndex}/>
                ...
                <h4 className="copyright">© All imagery and game music rights belong to Konami.</h4>
            </div>
        );
    }
}
